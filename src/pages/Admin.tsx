...
import { LayoutDashboard, ShoppingBag, Clock, CheckCircle2, Truck, Timer, Search, Ticket, Plus, Trash2, Edit3, X, AlertCircle, XCircle } from 'lucide-react';
                        ...
                        <div className="space-y-2 mb-6">
                          {order.items.map((item, idx) => (
                            <div key={idx} className="flex items-center justify-between gap-3">
                              ...
                              <span className="text-[10px] font-black text-zinc-400">₹{item.price * item.quantity}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-6 pb-5 border-b border-zinc-50 dark:border-zinc-900">
                          <div>
                            ...
                            <p className="text-xl font-black italic tracking-tighter text-zinc-900 dark:text-white uppercase">₹{order.total}</p>
                          </div>
                          <div className="text-right">
