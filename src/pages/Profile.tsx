...
import { User, Mail, MapPin, Hash, Shield, CheckCircle, Lock, Key, ChevronDown, ChevronUp, ArrowRight, BarChart3, ShoppingBag, CreditCard, Activity, Star, MessageSquare, Trash2, Edit3, Send, X } from 'lucide-react';
import { motion, AnimatePresence } from 'motion/react';
import { updatePassword, EmailAuthProvider, reauthenticateWithCredential } from 'firebase/auth';
import { auth } from '../lib/firebase';
import { userService, orderService, reviewService } from '../services/firebaseService';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        >
          <div className="relative z-10">
            ...
            <h3 className="text-3xl font-black italic tracking-tighter text-zinc-900 dark:text-white uppercase leading-none">₹{stats.totalSpent}</h3>
          </div>
          <div className="absolute -right-2 -bottom-2 opacity-[0.03] dark:opacity-[0.05] group-hover:scale-110 transition-transform duration-500">
             <CreditCard size={100} />
          </div>
                ...
                <div>
                  ...
                  <div className="relative group">
                     <input 
                      ...
                      placeholder="400055"
                      className="w-full px-6 bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 py-4 text-lg font-black tracking-tighter rounded-xl focus:ring-4 focus:ring-orange-500/10 transition-all text-zinc-900 dark:text-white" 
                    />
                  </div>
                </div>
              </div>
